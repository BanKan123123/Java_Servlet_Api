                ...
                <div id="login-box" class="col-md-12">
                    ...
                    <form id="login-form" class="form" action="<c:url value='/login?action=login'/>" method="post">
                        ...
                        <div class="form-group form-custom">
                            <a href="#" class="text-info">Quên mật khẩu</a><br>
                            <a href="#" class="text-info">Tạo tài khoản mới</a>
                        </div>
                        <div id="register-link">
                            <input type="submit" name="submit" class="btn btn-info btn-md btn-custom" value="Đăng nhập">
                        </div>
                    </form>
                </div>
            </div>
